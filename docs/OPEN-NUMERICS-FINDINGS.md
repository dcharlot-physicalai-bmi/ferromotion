...
**Trigger.** Static, minimal: `single_tet(8.0, 4.0)` with `x[3] = Vector3::new(0.0, 0.0, -0.2)` (J = -0.2). Dynamic and reachable with plausible parameters: `FemSim::box_grid(2,2,2, 0.3, mass 0.4, mu 4.0e2, lambda 2.0e2, dt 3e-4)`, `damping = 0.003`, `floor = Some(0.0)`, `k_contact = 1.0e5`, lifted 0.2 m and given v_z = -30 m/s.
